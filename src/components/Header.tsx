...
//               />
//             </div>
//             <span className="text-2xl font-bold text-primary">Visiomatix Media</span>
//           </Link>
...
//                 {item.subMenu ? (
//                   <DropdownMenu>
//                     <DropdownMenuTrigger className={`flex items-center space-x-1 text-sm font-medium transition-colors hover:text-primary ${isActive(item.href) ? "text-primary" : "text-foreground"
//                       }`}>
//                       <span>{item.name}</span>
